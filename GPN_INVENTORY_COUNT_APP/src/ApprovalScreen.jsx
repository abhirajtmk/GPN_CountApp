...
import { Box, ThemeProvider, Typography, createTheme, Chip } from "@mui/material";
...
export default function ApprovalScreen() {
	const { inventoryDetails, loading, allLocations, allUsers } = useSelector((state) => state.requests);
	...
	const { fetchInventoryCountDetails, fetchLocations, fetchUsers } = RequestActions;
